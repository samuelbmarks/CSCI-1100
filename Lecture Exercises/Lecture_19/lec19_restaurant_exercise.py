...
def build_restaurant_list( file_name ):
    ...
    for line in open(file_name):
        restaurant = convert_input_to_restaurant(line)
        if restaurant.average_review() > 3 and (restaurant.category == "American (Traditional)" or restaurant.category == "American (New)") and restaurant.address[1] == "Troy, NY 12180":
